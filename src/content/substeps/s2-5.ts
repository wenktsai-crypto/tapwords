  ...
  stories: [
    {
      ...
      sentences: [
        'Dan and Sam sprint to the shed.',
        'Dan is quick, and Sam is quick.',
        'Sam has a rip in his strap.',
        'Dan ran to the shed and sat.',
        'A big splash hit Sam in the mud.',
        'Dan is on the deck and not wet.',
        'Sam is wet, and Sam is sad.',
      ],
      questions: [
        { prompt: 'Who got to the shed?', choices: ['Dan', 'Sam', 'the strap'], answer: 0 },
        { prompt: 'Who got wet?', choices: ['Sam', 'Dan', 'the shed'], answer: 0 },
      ],
    },
    {
      title: 'The Duck and the Shrimp',
      sentences: [
        'The duck sat in a shrub.',
        ...
        'The duck can shrug and sit.',
      ],
      questions: [
        { prompt: 'Where did the duck sit?', choices: ['in a shrub', 'in the mud', 'on a rock'], answer: 0 },
        { prompt: 'What did the duck squint at?', choices: ['the shrimp', 'the shrub', 'the sun'], answer: 0 },
      ],
    },
  ],
};
