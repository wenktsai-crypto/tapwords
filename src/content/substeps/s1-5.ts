...
export const SUBSTEP_1_5: Substep = {
  ...
  groups: [
    {
      ...
      lesson: [
        ...
        { show: ['am', 'an'] },
        { say: 'When a comes just before m or n, the a sound changes a little, so we tap am and an as one chunk instead of two sounds.' },
        { tap: 'ham' },
  ...
  words: [
    ...
    nonsense('shan', 'sh,an'), nonsense('yan', 'y,an'), nonsense('chan', 'ch,an'),
    nonsense('quan', 'qu,an'),
  ],
  sentences: [
  ...
  stories: [
    {
      ...
      sentences: [
        'Sam has a big pan.',
        'Pam has ham and jam.',
        'Sam and Pam sit in the sun.',
        'The jam is in the pan.',
        'A red hen ran to the pan.',
        'The hen has jam on his leg.',
        'Sam and Pam do not have jam.',
        'The hen has fun in the sun.',
      ],
      questions: [
        { prompt: 'What is in the pan?', choices: ['jam', 'ham', 'a hen'], answer: 0 },
    ...
    },
    {
      ...
      questions: [
        { prompt: 'What is in the van?', choices: ['a big fan', 'a red rug', 'a tan map'], answer: 0 },
