...
export const SUBSTEP_2_2: Substep = {
  ...
  words: [
    ...
    cvcNonsense('flib'), cvcNonsense('steb'), cvcNonsense('plim'), cvcNonsense('trup'),
  ...
  stories: [
    {
      ...
      sentences: [
        'A frog is on a raft.',
        'The raft is on a big pond.',
        'A crab is on the raft too.',
        'The raft can not stop.',
        'The frog must jump fast.',
        'The frog and the crab jump on the sand.',
        'They sit on the sand and clap.',
      ],
      questions: [
        { prompt: 'Where is the frog at the start of the story?', choices: ['on a raft', 'on the sand', 'in the pond'], answer: 0 },
        { prompt: 'What does the frog do?', choices: ['jump fast', 'sit in the pond', 'stop the raft'], answer: 0 },
      ],
    },
    {
      title: 'The Crab and the Flag',
      sentences: [
        'A crab is on the sand.',
        'A flag is on the sand too.',
      ...
      questions: [
        { prompt: 'What does the crab grab?', choices: ['the flag', 'the sand', 'the frog'], answer: 0 },
        { prompt: 'Who can jump on the sand?', choices: ['a frog', 'a crab', 'a flag'], answer: 0 },
      ],
    },
  ],
};
