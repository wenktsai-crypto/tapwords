...
export const SUBSTEP_3_1: Substep = {
  ...
  words: [
    ...
    // Nonsense: same two-syllable shapes, never a real word. Each carries its own syllable
    // cut, so this section's whole point — find the two parts — is visible on the tiles.
    { ...nonsense('napsit', 'n,a,p,s,i,t'), syllables: [3] },
    { ...nonsense('nimtub', 'n,i,m,t,u,b'), syllables: [3] },
    { ...nonsense('zunmap', 'z,u,n,m,a,p'), syllables: [3] },
    { ...nonsense('fesket', 'f,e,s,k,e,t'), syllables: [3] },
    { ...nonsense('jomtef', 'j,o,m,t,e,f'), syllables: [3] },
    { ...nonsense('vimlub', 'v,i,m,l,u,b'), syllables: [3] },
    { ...nonsense('fibbit', 'f,i,b,b,i,t'), syllables: [3] },
    { ...nonsense('cadmun', 'c,a,d,m,u,n'), syllables: [3] },
    { ...nonsense('hupten', 'h,u,p,t,e,n'), syllables: [3] },
    { ...nonsense('miglit', 'm,i,g,l,i,t'), syllables: [3] },
    { ...nonsense('mibbet', 'm,i,b,b,e,t'), syllables: [3] },
    { ...nonsense('mudnak', 'm,u,d,n,a,k'), syllables: [3] },
    { ...nonsense('pebbin', 'p,e,b,b,i,n'), syllables: [3] },
    { ...nonsense('fennup', 'f,e,n,n,u,p'), syllables: [3] },
    { ...nonsense('vacket', 'v,a,ck,e,t'), syllables: [3] },
    { ...nonsense('tadon', 't,a,d,o,n'), syllables: [3] },
    { ...nonsense('muzlop', 'm,u,z,l,o,p'), syllables: [3] },
    { ...nonsense('wemtuck', 'w,e,m,t,u,ck'), syllables: [3] },
    { ...nonsense('vozlin', 'v,o,z,l,i,n'), syllables: [3] },
    { ...nonsense('pandim', 'p,a,n,d,i,m'), syllables: [3] },
  ],
  sentences: [
    'The rabbit has a muffin in the cabin.',
    'A robin can land on the wagon.',
  ...
  stories: [
    {
      ...
      sentences: [
        ...
        'The rabbit has a big muffin on a red mat.',
        'A kitten is in the cabin too.',
        'The rabbit can hop to the tub.',
        'Now the kitten can grab the muffin off the mat.',
        'The kitten has the muffin, and the rabbit has the mat.',
      ],
      questions: [
        { prompt: 'Where does the rabbit hop to?', choices: ['the tub', 'the mat', 'the cabin'], answer: 0 },
    ...
    },
    {
      ...
      sentences: [
        ...
        'The robin can lift the muffin out of the basket.',
    ...
    },
    {
      ...
      sentences: [
        ...
        'A rock can drop in the tunnel, and the helmet will help Sam.',
        'Sam can hop into the big tunnel.',
        'A goblin is in the tunnel too.',
        'The goblin can grab the backpack from Sam.',
        'Sam is upset, and Sam can yell at the goblin.',
        'The goblin can hand the backpack back to Sam.',
      ],
      questions: [
        { prompt: 'What did the goblin grab from Sam?', choices: ['the backpack', 'the helmet', 'the rock'], answer: 0 },
    ...
    },
    {
      ...
      sentences: [
        'Sam has a big catfish from the pond in the bathtub.',
        'The catfish can swim fast in the tub.',
        'Sam has a net.',
        'Sam can grab the catfish in the net.',
        'Sam can run to the pond with the net.',
        'Sam can put the catfish back in the pond.',
      ],
      questions: [
        { prompt: 'What does Sam have in the bathtub at the start?', choices: ['a catfish', 'a net', 'a pond'], answer: 0 },
