...
export const SUBSTEP_3_1: Substep = {
  ...
  sentences: [
    ...
    'About one muffin is on the mat.',
  ...
  stories: [
    {
      ...
      sentences: [
        'A rabbit sat in a cabin at sunset.',
        'The rabbit has a big muffin.',
        'The muffin is on a red mat.',
        'The rabbit has a picnic in the cabin.',
        'Now the muffin is not on the mat.',
        'The rabbit is not sad.',
      ],
      questions: [
        { prompt: 'Where did the rabbit sit?', choices: ['in a cabin', 'on a mat', 'in the sun'], answer: 0 },
        { prompt: 'What did the rabbit have?', choices: ['a muffin', 'a picnic', 'a red mat'], answer: 0 },
      ],
    },
    {
