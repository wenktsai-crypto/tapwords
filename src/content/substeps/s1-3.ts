...
export const SUBSTEP_1_3: Substep = {
  ...
  sentences: [
    ...
    'The math is not much fun.',
    'Hush! The chick is in the shed.',
  ...
  stories: [
    {
      ...
      sentences: [
        ...
        'The duck was in the mud.',
        'The duck has fun in the mud.',
        'The chick is not wet yet.',
        'The duck was quick.',
        'Mud was on the chick.',
        'The chick is wet, and she is not mad.',
        'They nap in the sun.',
      ],
      questions: [
        { prompt: 'Who got wet?', choices: ['the chick', 'the rock', 'the sun'], answer: 0 },
        { prompt: 'Where do they nap?', choices: ['in the sun', 'in the mud', 'on a rug'], answer: 0 },
      ],
    },
    {
      ...
      sentences: [
        ...
        'The sock is in a box on the shed.',
        'A duck and a chick check the box.',
        'The duck is quick, and he has the sock.',
        'The kid was not mad.',
        'He and the duck run to the shop.',
        'The kid has a fig, and the duck has a fish.',
